...
@interface AVCallRingTool () <AVAudioPlayerDelegate>

@property (nonatomic, strong) AVAudioPlayer              *player;

@end

@implementation AVCallRingTool

static AVCallRingTool *_ringCallManager = nil;

+ (AVCallRingTool *)shareManager {
    
    if (!_ringCallManager) {
        _ringCallManager = [[AVCallRingTool alloc] init];
    }
